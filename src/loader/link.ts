...
module COLLADA.Loader {
    ...
    export interface LinkResolveResult {
        result: COLLADA.Loader.Element | undefined;
    ...
    */
    export class Link {
        url: string = "";
        target: COLLADA.Loader.Element | undefined;
    ...
    */
    export class FxLink extends Link {
        scope: COLLADA.Loader.Element | undefined;
        ...
        resolve(context: COLLADA.Loader.Context): void {
            var scope: COLLADA.Loader.Element | undefined = this.scope;
            var object: COLLADA.Loader.Element | undefined = undefined;
    ...
    export class SidLink extends Link {
        ...
        */
        static findSidTarget(url: string, root: COLLADA.Loader.Element, sids: string[], context: COLLADA.Context): LinkResolveResult {
            ...
            var childObject: COLLADA.Loader.Element | undefined = undefined;
            ...
            for (var i: number = 0, ilen: number = sids.length; i < ilen; i++) {
                ...
                while (queue.length !== 0) {
                    ...
                    var front: COLLADA.Loader.Element | undefined = queue.shift();
                    if (front) {
        ...
        resolve(context: COLLADA.Loader.Context): void {
            var object: COLLADA.Loader.Element | undefined;
            if (this.id == null) {
